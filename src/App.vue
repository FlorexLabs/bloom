  ...
  <div>
    ...
    <transition-group name="toast" tag="div" class="fixed top-4 right-4 z-50 space-y-2">
      <div v-for="toast in toasts" :key="toast.id"
        ...
        <div class="flex-shrink-0">
          ...
          <svg v-if="toast.type === 'error'" class="w-5 h-5 text-red-500" fill="none" stroke="currentColor"
               viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                  d="M12 8v4m0 4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path>
          </svg>
          <svg v-if="toast.type === 'info'" class="w-5 h-5 text-teal-500" fill="none" stroke="currentColor"
               viewBox="0 0 24 24">
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
    ...
    <transition name="fade">
      <div v-if="sidebarOpen" @click="sidebarOpen = false"
           class="fixed inset-0 bg-[#00000030] bg-opacity-50 z-30 lg:hidden"></div>
    </transition>
      ...
      <main class="p-4 lg:p-6">
        ...
        <div v-if="currentView === 'dashboard'">
          ...
          <div class="flex items-center justify-between mb-4">
            ...
            <button @click="showToast('Feature coming soon!', 'info')"
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
            <div v-for="service in services" :key="service.id"
                 @click="selectedService = service; currentView = 'service-detail'"
              ...
              <div class="flex items-start justify-between mb-4">
                ...
                <span :class="[
                                    ...
                                    service.status === 'warning' ? 'bg-yellow-100 dark:bg-yellow-500/10 text-yellow-700 dark:text-yellow-400' :
              ...
              <div class="h-16 flex items-end gap-1">
                <div v-for="(value, index) in service.sparkline" :key="index"
                     :style="{ height: value + '%' }"
                     class="flex-1 bg-teal-200 dark:bg-teal-500/30 rounded-t group-hover:bg-teal-400 dark:group-hover:bg-teal-500 transition-colors"></div>
              </div>
            </div>
          </div>
        </div>
              ...
              <table class="w-full">
                ...
                <tr v-for="service in services" :key="service.id"
                  ...
                  <td class="px-6 py-4 whitespace-nowrap text-sm">
                    <button @click.stop="showToast('Feature coming soon!', 'info')"
            ...
            <div class="lg:col-span-2 space-y-6">
                ...
                <div class="flex items-start justify-between mb-6">
                  <div>
                    <div class="flex items-center gap-3 mb-2">
                      ...
                      <h1 class="text-2xl font-bold text-gray-900 dark:text-white">{{ selectedService.name }}</h1>
                    </div>
                    <p class="text-gray-500 dark:text-gray-400">{{ selectedService.type }} Service</p>
                  </div>
                  <div class="flex gap-2">
                    <button @click="showToast('Service paused', 'info')"
                    ...
                    <button @click="showToast('Service deleted', 'success'); currentView = 'dashboard'"
              ...
              <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="h-64 flex items-end gap-2">
                  <div v-for="(value, index) in Array.from({length: 24}, () => Math.random() * 100)" :key="index"
                       :style="{ height: value + '%' }"
                       class="flex-1 bg-gradient-to-t from-teal-500 to-teal-300 rounded-t opacity-80 hover:opacity-100 transition-opacity"></div>
                </div>
              ...
              <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="space-y-3">
                  <div v-for="alert in alertHistory.filter(a => a.service === selectedService.name).slice(0, 5)"
                       :key="alert.id"
            ...
            <div class="space-y-6">
              ...
              <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
                ...
                <div class="space-y-2">
                  ...
                  <button @click="showToast('Logs exported', 'success')"
                          class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 text-sm font-medium transition-colors">
                    Export Logs
                  </button>
                </div>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div class="border-b border-gray-200 dark:border-gray-700">
              <nav class="flex -mb-px">
                <button v-for="channel in alertChannels" :key="channel.id"
              ...
              <div v-for="channel in alertChannels" :key="channel.id" v-show="activeAlertTab === channel.id">
                <div class="max-w-2xl">
                  <div class="flex items-center justify-between mb-6">
                    <div>
                      <h3 class="text-lg font-semibold text-gray-900 dark:text-white">{{ channel.name }}
                        Configuration</h3>
                      <p class="text-sm text-gray-500 dark:text-gray-400 mt-1">Configure {{ channel.name }} alerts for
                        your services</p>
                    </div>
                  ...
                  <div class="space-y-4">
                    ...
                    <div v-if="channel.id === 'telegram'">
                      ...
                      <input type="text" placeholder="123456789:ABCdefGHIjklMNOpqrsTUVwxyz"
                    ...
                    <div v-if="channel.id === 'mattermost'">
                      <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-2">Webhook URL</label>
                      <input type="text" placeholder="https://mattermost.example.com/hooks/..."
                             class="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:ring-2 focus:ring-teal-500 focus:border-transparent">
                    </div>

                    <div class="flex gap-3 pt-4">
                      <button @click="showToast('Test notification sent!', 'success')"
                              class="px-4 py-2 border border-gray-300 dark:border-gray-600 text-gray-700 dark:text-gray-300 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 text-sm font-medium transition-colors">
                        Send Test
                      </button>
                      <button @click="showToast('Settings saved!', 'success')"
                              class="px-4 py-2 bg-teal-500 hover:bg-teal-600 text-white rounded-lg text-sm font-medium transition-colors">
                        Save Configuration
                      </button>
                    </div>
          ...
          <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
            <div class="p-4 border-b border-gray-200 dark:border-gray-700">
              <div class="flex items-center gap-4">
                ...
                <select v-model="logSeverityFilter"
                ...
                <tr v-for="log in filteredLogs" :key="log.id"
                  ...
                  <td class="px-6 py-4 whitespace-nowrap">
                                            <span :class="[
                                                ...
                                                log.severity === 'error' ? 'bg-orange-100 dark:bg-orange-500/10 text-orange-700 dark:text-orange-400' :
                                                log.severity === 'warning' ? 'bg-yellow-100 dark:bg-yellow-500/10 text-yellow-700 dark:text-yellow-400' :
  ...
  data() {
    return {
      ...
      alertChannels: [
        ...
        {id: 'telegram', name: 'Telegram', icon: 'M12 19l9 2-9-18-9 18 9-2zm0 0v-8', enabled: false},
        {
          id: 'mattermost',
          name: 'Mattermost',
      ...
      alertHistory: [
        ...
        {id: 3, service: 'rails-api', message: 'Service recovered', severity: 'info', timestamp: '2024-01-15 13:45:11'},
        {
          id: 4,
      ...
      notifications: [
        {id: 1, title: 'Service Down', message: 'email-processor is not responding', time: '5 min ago'},
        {id: 2, title: 'High Response Time', message: 'auth-service response time above threshold', time: '10 min ago'},
        {id: 3, title: 'Service Recovered', message: 'rails-api is back online', time: '1 hour ago'}
      ]
    };
  },
  computed: {
    ...
    filteredLogs() {
      return this.systemLogs.filter(log => {
        const matchesSearch = log.message.toLowerCase().includes(this.logSearch.toLowerCase()) ||
